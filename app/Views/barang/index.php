...
<div class="content-wrapper">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <button type="submit" class="btn btn-success"><a href="<?= base_url('barang/tambah') ?>" style="color: white;"> + Tambah Data Barang</a></button>
            <br><br><br>
                    ...
                    foreach ($list_barang as $value) { ?>
                        <tr class="text-center">
                            ...
                            <td class="d-flex justify-content-center">
                                ...
                                <form method="post" action="<?= base_url('barang/hapus/' . $value['id']) ?>" onsubmit="return confirm('Apakah yakin akan menghapus data ini?')">
